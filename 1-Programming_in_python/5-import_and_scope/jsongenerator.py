...
def create_dict(name, age, title):
    ...
    value = [str(name), int(age), str(title)]
    employee_dict = {key: value for key,value in zip(key,value)}
    employee_data = json.dumps(employee_dict)
